					...
					<table class="table2 table-bordered table-sm">
						...
						<tr>
							...
							<td>
								<div class="container">
									<div class="row">
										<?php echo $this->Form->input('EventManager.' . $key . '.lastname', array('type' => 'text', 'div' => false, 'label' => false, 'error' => false, 'class' => 'form-control form-control-sm col-5', 'placeholder' => '姓')); ?>&nbsp;
										<?php echo $this->Form->input('EventManager.' . $key . '.firstname', array('type' => 'text', 'div' => false, 'label' => false, 'error' => false, 'class' => 'form-control form-control-sm col-5', 'placeholder' => '名')); ?>
							...
							<td>
								<div class="container">
									<div class="row">
										<?php echo $this->Form->input('EventManager.' . $key . '.lastname_kana', array('type' => 'text', 'div' => false, 'label' => false, 'error' => false, 'class' => 'form-control form-control-sm col-5', 'placeholder' => 'セイ')); ?>&nbsp;
										<?php echo $this->Form->input('EventManager.' . $key . '.firstname_kana', array('type' => 'text', 'div' => false, 'label' => false, 'error' => false, 'class' => 'form-control form-control-sm col-5', 'placeholder' => 'メイ')); ?>
						...
						<tr>
							...
							<td>
								<?php echo $this->Form->input('EventManager.' . $key . '.zip', array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm', 'onKeyUp' => 'AjaxZip3.zip2addr(this,"","data[EventManager][' . $key . '][prefecture_id]", "data[EventManager][' . $key . '][city]")')); ?>
				...
				<?php foreach ( $this->request->data['EventAffair'] as $key => $event_affair ): ?>
					...
					<table class="table2 table-bordered table-sm">
						...
						<tr>
							<th class="bg-light" nowrap="nowrap">郵便番号<span class="text-danger">*</span></th>
							<td>
								<?php echo $this->Form->input('EventAffair.' . $key . '.zip', array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control', 'onKeyUp' => 'AjaxZip3.zip2addr(this,"","data[EventAffair][' . $key . '][prefecture_id]", "data[EventAffair][' . $key . '][city]")')); ?>
								<span class="text-danger small">例）000-0000</span>
