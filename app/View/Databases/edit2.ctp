...
<?php echo $this->Form->create(null, array('type' => 'post', 'url' => 'edit2')); ?>
	<div class="container">
		...
		<table class="table table-bordered table-sm">
			<tr>
				<th class="bg-light">趣旨・目的<span class="text-danger">*</span><br>
			...
			<tr>
				<th class="bg-light w-25">プログラム<span class="text-danger">*</span><br>
					（未定の場合はプログラム編成の方針、講演者候補等を明記）</th>
				<td>
					<?php echo $this->Form->input('Event.program', array('type' => 'textarea', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm')); ?>
					<span class="text-danger small">（開催時期が変更になる可能性がある場合はその旨明記）</span>
				</td>
			</tr>
			<tr>
				<th class="bg-light">取り扱うテーマ・トピックや解決すべき課題<span class="text-danger">*</span></th>
				<td>
					<?php echo $this->Form->input('Event.subject', array('type' => 'textarea', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm')); ?>
				</td>
			</tr>
			<tr>
				<th class="bg-light">考えられる数学・<br>数理科学的アプローチ<span class="text-danger">*</span></th>
				<td>
			...
			<tr>
				<th class="bg-light">これまでの準備状況<span class="text-danger">*</span></th>
				<td>
			...
			<tr>
				<th class="bg-light">終了後のフォローアップの計画<span class="text-danger">*</span></th>
				<td>
					<?php echo $this->Form->input('Event.follow', array('type' => 'textarea', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm')); ?>
				</td>
			</tr>
			<tr>
				<th class="bg-light">他機関からの支援<span class="text-danger">*</span></th>
				<td>
