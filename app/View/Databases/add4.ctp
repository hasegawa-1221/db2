...
<?php echo $this->Form->create(null, array('type' => 'post', 'url' => 'add4')); ?>
	<div class="container">
		<h2>企画応募</h2>
		...
		<table class="table table-bordered table-sm">
			...
			<tr>
				...
				<td>
					<?php echo $this->Form->input('Event.qualification_cost', array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
				</td>
			</tr>
			*/ ?>
		...
		<div class="text-center">
				<?php echo $this->Html->link('戻る', array('action' => 'add3'), array('class' => 'btn btn-secondary')); ?>&nbsp;&nbsp;
