...
<?php echo $this->Form->create(null, array('type' => 'post', 'url' => 'add2')); ?>
	<div class="container">
		<h2>企画応募</h2>
		...
		<table class="table table-bordered table-sm">
			<tr>
				<th class="bg-light">
					趣旨・目的<br>
					（具体的に記載のこと：何をやることでどのような効果を期待しているのか等について記載）
				</th>
				<td>
					<?php echo $this->Form->input('Event.purpose', array('type' => 'textarea', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
				</td>
			</tr>
			<tr>
				<th class="bg-light w-25">
					プログラム<br>
					（未定の場合はプログラム編成の方針、講演者候補等を明記）
				</th>
				<td>
					<?php echo $this->Form->input('Event.program', array('type' => 'textarea', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<?php echo $this->Form->input('Event.approach', array('type' => 'textarea', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<?php echo $this->Form->input('Event.prepare', array('type' => 'textarea', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					...
					<br>
					有の場合は支援元<br>
					<?php echo $this->Form->input('Event.support', array('type' => 'textarea', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
				</td>
			</tr>
		</table>
		
		<div class="text-center">
			<?php echo $this->Html->link('戻る', array('action' => 'add1'), array('class' => 'btn btn-secondary')); ?>&nbsp;&nbsp;
