...
<?php echo $this->Form->create(null, array('type' => 'post', 'url' => 'edit3')); ?>
	<div class="container">
		<h2>企画応募</h2>
		...
		<div class="alert alert-danger">
			下記、経費内訳については採択後採択金額内で変更は可能です。現時点での使用予定をご入力ください
		</div>
			...
			<tbody>
				...
				if ( !empty($this->request->data['Expense']['1']) ):
					...
					<tr>
						...
						<?php /*<td><?php echo $this->Form->input('Expense.1.' . $i . '.title',				array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm')); ?></td> */ ?>
						...
						<td><?php echo $this->Form->input('Expense.1.' . $i . '.request_price',		array('type' => 'number', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm text-right form-request_price item-id-1')); ?></td>
				...
				if ( !empty($this->request->data['Expense']['2']) ):
					...
					<tr>
						<td>
							...
							<?php echo $this->Form->input('Expense.2.' . $i . '.affiliation',	array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm form-affiliation')); ?>
						</td>
						...
						<td><?php echo $this->Form->input('Expense.2.' . $i . '.request_price',		array('type' => 'number', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm text-right form-request_price item-id-2')); ?></td>
		...
		<table class="table2 table-bordered table-sm" id="item-id-3">
			...
			<tbody>
				...
				if ( !empty($this->request->data['Expense']['3']) ):
					...
					<tr>
						<td><?php echo $this->Form->input('Expense.3.' . $i . '.id',				array('type' => 'hidden')); ?>
							<?php echo $this->Form->input('Expense.3.' . $i . '.title',				array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm')); ?></td>
						<td><?php echo $this->Form->input('Expense.3.' . $i . '.count',				array('type' => 'number', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm form-count', 'attr-item-id' => 3, 'attr-i' => $i)); ?></td>
						<td><?php echo $this->Form->input('Expense.3.' . $i . '.price',				array('type' => 'number', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm form-price', 'attr-item-id' => 3, 'attr-i' => $i)); ?></td>
						<td><?php echo $this->Form->input('Expense.3.' . $i . '.request_price',		array('type' => 'number', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm text-right form-request_price item-id-3')); ?></td>
		...
		<table class="table2 table-bordered table-sm" id="item-id-4">
			...
			<tbody>
				...
				if ( !empty($this->request->data['Expense']['4']) ):
					...
					<tr>
						<td><?php echo $this->Form->input('Expense.4.' . $i . '.id',				array('type' => 'hidden')); ?>
							<?php echo $this->Form->input('Expense.4.' . $i . '.title',				array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm')); ?></td>
						<td><?php echo $this->Form->input('Expense.4.' . $i . '.count',				array('type' => 'number', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm form-count', 'attr-item-id' => 4, 'attr-i' => $i)); ?></td>
						<td><?php echo $this->Form->input('Expense.4.' . $i . '.price',				array('type' => 'number', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm form-price', 'attr-item-id' => 4, 'attr-i' => $i)); ?></td>
						<td><?php echo $this->Form->input('Expense.4.' . $i . '.request_price',		array('type' => 'number', 'div' => false, 'label' => false, 'class' => 'form-control form-control-sm text-right form-request_price item-id-4')); ?></td>
			...
			<div class="row">
				<div class="col-12 col-sm-6 offset-sm-6">
					<table class="table table-bordered table-sm">
						...
						<tr>
							<td colspan="2">※申請できる金額の合計は原則として60万円以内とします。</td>
						</tr>
					</table>
				</div>
			</div>
		...
		<div class="text-center">
			<?php echo $this->Html->link('戻る', array('action' => 'edit2'), array('class' => 'btn btn-secondary')); ?>
