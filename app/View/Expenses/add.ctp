			...
			<div class="col-12 col-sm-6">
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td>
							<div class=" form-inline">
								<?php echo $this->Form->input('Expense.affiliation',		array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
							</dvi>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<div class=" form-inline">
								<?php echo $this->Form->input('Expense.title',				array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
							</div<
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<div class=" form-inline">
								<?php echo $this->Form->input('Expense.request_price',		array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
							</dvi>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class=" form-inline">
								<?php echo $this->Form->input('Expense.accept_price',		array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class=" form-inline">
								<?php echo $this->Form->input('Expense.note',				array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
							</dvi>
						</td>
					</tr>
				</table>
			...
			<div class="col-12 col-sm-6">
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<td>
							<div class=" form-inline">
								<?php echo $this->Form->input('Expense.execution_cd',	array('type' => 'select', 'div' => false, 'label' => false, 'class' => 'form-control', 'options' => $items)); ?>
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<div class=" form-inline">
								<?php echo $this->Form->input('Expense.partner_name',		array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<div class=" form-inline">
								<?php echo $this->Form->input('Expense.ask_title',				array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class=" form-inline">
								<?php echo $this->Form->input('Expense.comment',			array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control')); ?>
							</dvi>
						</td>
					</tr>
					<tr>
