...
<?php echo $this->Html->script('jquery.smoothScroll.min'); ?>
<?php echo $this->Html->script('jquery.simplePagination'); ?>
<?php echo $this->Html->script('common'); ?>
<?php echo $this->Html->script('ajaxzip3'); ?>

<?php
if ( $this->action == 'researcher_detail' )
{
	echo $this->Element( 'researcher_detail_footer', array('pager_count' => $pager_count) );
}
?>
