			...
			<div class="row pb-4">
				<div class="col-2">
					 <div class="input-group">
						...
						<?php echo $this->Form->input('Search.keyword', array('type' => 'text', 'div' => false, 'label' => false, 'class' => 'form-control', 'placeholder' => '主催機関')); ?>
					</div>
				</div>
			</div>
...
<p class="alert alert-warning">
	主催機関右の <i class="fa fa-plus" aria-hidden="true"></i> をクリックすると、研究機関登録画面に遷移します。
</p>
	...
	<div class="table-responsive">
		<table class="table table-bordered table-striped">
			<tr>
				...
				<th><?php echo $this->Paginator->sort('Event.organization',			'主催機関'); ?></th>
			...
			foreach ( $events as $event ): ?>
				<tr>
					...
					<td>
						...
						<?php echo $this->Html->link('<i class="fa fa-plus" aria-hidden="true"></i>', array('controller' => 'affiliations', 'action' => 'add', $event['Event']['id']), array('escape' => false)); ?>
					</td>
