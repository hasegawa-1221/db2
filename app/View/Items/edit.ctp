<h2>課目の作成</h2>
<?php echo $this->Form->create(null, array('type' => 'post', 'url' => 'edit/' . $item['Item']['id'])); ?>
	<div class="row">
		<div class="col-12 text-center">
			...
			<hr>
			<div class="mb-3">
				<?php echo $this->Form->input('Item.is_delete', array('type' => 'checkbox', 'div' => false, 'label' => false, 'class' => '')); ?>
				<label for="ItemIsDelete">チェックを付けて削除とする</label>
			</div>
			<hr>
		</div>
	</div>
